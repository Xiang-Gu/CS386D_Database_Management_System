...
javac sorted_indexOnBothCols.java
java sorted_indexOnBothCols
*/

import java.sql.*;
import java.util.*;

public class sorted_indexOnBothCols {
	static int total = 5000000; // total rows
	static String physicalConfig = "Sorted Order, Index on columnA and columnB!!!\n";
