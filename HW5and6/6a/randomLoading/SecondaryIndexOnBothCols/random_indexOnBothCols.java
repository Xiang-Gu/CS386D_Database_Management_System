...
javac random_indexOnBothCols.java
java random_indexOnBothCols
*/

import java.sql.*;
import java.util.*;

public class random_indexOnBothCols {
	static int total = 5000000; // total rows
	static String physicalConfig = "Random Order, Index on columnA and columnB!!!\n";
	...
	public static double timeInsertRow(Connection conn) throws SQLException {
		...
		// generate total rows in random order on the primary key
		Random rand = new Random();
	...
	public static void main(String[] args) throws SQLException, ClassNotFoundException {
		...
		System.out.println("\nTime to insert " + total + " rows = " + loadingTime + "s\n");
